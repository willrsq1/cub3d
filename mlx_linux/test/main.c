...
int	color_map_2(unsigned char *data,int bits_per_pixel,int sl,int w,int h,int endian, int type);
...
int	main()
{
  ...
  data1 = mlx_get_data_addr(im1,&bits_per_pixel1,&sl1,&endian1);
  printf("OK (bits_per_pixel1: %d, sizeline1: %d endian: %d type: %d)\n",bits_per_pixel1,sl1,endian1,
	 ((t_img *)im1)->type);

  printf(" => Fill Image1 ...");
  color_map_2(data1,bits_per_pixel1,sl1,IM1_SX,IM1_SY,endian1, 1);
  printf("OK (pixmap : %d)\n",(int)((t_img *)im1)->pix);
  ...
  data3 = mlx_get_data_addr(im3,&bits_per_pixel3,&sl3,&endian3);
  printf("OK (bits_per_pixel3 %d, sizeline3 %d endian3 %d type %d)\n",bits_per_pixel3,sl3,endian3,
	 ((t_img *)im3)->type);

  printf(" => Fill Image3 ...");
  color_map_2(data3,bits_per_pixel3,sl3,IM3_SX,IM3_SY,endian3, 1);
  printf("OK (pixmap : %d)\n",(int)((t_img *)im3)->pix);
  ...
  data2 = mlx_get_data_addr(im2,&bits_per_pixel2,&sl2,&endian2);
  printf("OK (xpm %dx%d)(img bits_per_pixel2: %d, sizeline2: %d endian: %d type: %d)\n",
	 xpm1_x,xpm1_y,bits_per_pixel2,sl2,endian2,((t_img *)im2)->type);
  sleep(2);
  ...
  data4 = mlx_get_data_addr(im4,&bits_per_pixel4,&sl4,&endian4);
  color_map_2(data4,bits_per_pixel4,sl4,IM3_SX,IM3_SY,endian4, 2);
